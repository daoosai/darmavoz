...
Текущая версия проекта: `2.7.0`.

Sprint 18 завершён. В тестовом контуре зафиксирован независимый жизненный цикл размещений для точек забора и объявлений спецтехники: тестовый период, срок размещения, регулярное подтверждение актуальности, автоматическое скрытие, предупреждение о скором окончании размещения и ручное продление оператором. Временные QA-инструменты для ручного состаривания таймера подтверждения удалены из кода после завершения проверки.
