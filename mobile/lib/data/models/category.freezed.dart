...
mixin _$Category {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, slug, sortOrder, isActive);

  @override
  String toString() {
    return 'Category(id: $id, name: $name, slug: $slug, sortOrder: $sortOrder, isActive: $isActive)';
  }
}
...
extension CategoryPatterns on Category {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Category() when $default != null:
        return $default(
            _that.id, _that.name, _that.slug, _that.sortOrder, _that.isActive);
      case _:
        return orElse();
    }
  }
