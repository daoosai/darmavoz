import { ClipboardList, Droplets, Headphones, UserRound } from "lucide-react";

export type EquipmentOwnerTab = "equipment" | "septic" | "support" | "profile";
...
const ITEMS = [
  { id: "septic" as const, label: "Септики", icon: Droplets },
