...
mixin _$Product {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, description, price, unitType, imageUrl);

  @override
  String toString() {
    return 'Product(id: $id, name: $name, description: $description, price: $price, unitType: $unitType, imageUrl: $imageUrl)';
  }
}
